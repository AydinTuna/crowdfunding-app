                ...
                <>
                    <p className='absolute text-md font-bold'>
                        ...
                        <span className='underline underline-offset-2'>
                            <input type="datetime" name="dateFrom" id="dateFrom" value={range.from} hidden />
                            <input type="datetime" name="dateTo" id="dateTo" value={range.to} hidden />
